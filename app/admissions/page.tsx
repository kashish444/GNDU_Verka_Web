...
<section className="bg-[#0c2340] text-white py-12">
          <div className="container mx-auto px-4">
            ...
            <p className="mt-2 text-lg">Empowering Minds, Shaping Futures – Explore Our Diverse Courses at GNDU College Verka-Amritsar</p>
          </div>
        </section>
                      ...
                      <Table>
                        ...
                        <TableBody>
                          <TableRow>
                            ...
                            <TableCell className="text-right"><a href="https://example.com/ba-syllabus" target="_blank" rel="noopener noreferrer"
                                       style={{ color: "blue", cursor: "pointer" }}>Link</a>
                            </TableCell>
                          </TableRow>
                          <TableRow>
