          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#0c2340]">
                Student Life at GNDU
              </h2>
              <p className="text-gray-700">
                The Student Corner is your gateway to all student-related
                resources, activities, and support services. We are committed to
                providing a nurturing environment where students can thrive
                academically, socially, and personally. Explore the various
                facilities, clubs, and support systems available to enhance your
                college experience.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Promotes cultural activities, organizes festivals, and
                    celebrates diverse traditions through music, dance, and
                    drama.
                  </p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Fosters love for literature through debates, poetry
                    sessions, creative writing workshops, and literary
                    competitions.
                  </p>
                  <Button variant="outline" className="w-full">
                    Learn More
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Engages students in community service, social awareness
                    campaigns, and volunteer activities for societal
                    development.
                  </p>
                  <Button variant="outline" className="w-full">
                    Learn More
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    <div className="space-y-4 p-2">
                      <p className="text-gray-700">
                        Merit scholarships are awarded to students who
                        demonstrate exceptional academic performance.
                      </p>
                      <ul className="list-disc pl-5 space-y-1 text-gray-700">
                        <li>
                          University Merit Scholarship: For top 10% students in
                          each program
                        </li>
                        <li>
                          Academic Excellence Award: For students with 90% or
                          above in previous academic year
                        </li>
                        <li>
                          Subject Topper Scholarship: For students ranking first
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent>
                    <div className="space-y-4 p-2">
                      <p className="text-gray-700">
                        Various government scholarships are available for
                        eligible students based on different criteria.
                      </p>
                      <ul className="list-disc pl-5 space-y-1 text-gray-700">
                        ...
                        <li>
                          State Government Scholarships for minority communities
                        </li>
                      </ul>
                      <p className="text-gray-700 mt-2">
                        <span className="font-semibold">
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent>
                    <div className="space-y-4 p-2">
                      <p className="text-gray-700">
                        Financial aid is available for students facing economic
                        hardships to ensure that financial constraints do not
                        hinder education.
                      </p>
                      <ul className="list-disc pl-5 space-y-1 text-gray-700">
                        <li>
                          Fee Concession: Partial or full fee waiver based on
                          financial need
                        </li>
                        <li>
                          Book Bank Facility: Free textbooks for economically
                          disadvantaged students
                        </li>
                        <li>
                          Emergency Financial Assistance: For students facing
                          unexpected financial crises
                        </li>
                      </ul>
                      <p className="text-gray-700 mt-2">
                        <span className="font-semibold">Contact:</span>{" "}
                        Financial Aid Office, Administrative Block
                      </p>
                      <Button className="mt-2" variant="outline">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    The college has a well-equipped medical room with a
                    qualified nurse available during college hours. First aid
                    and basic medical services are provided for minor health
                    issues and emergencies.
                  </p>
                  <p className="text-gray-700 mt-2">
                    <span className="font-semibold">Location:</span> Ground
                    Floor, Administrative Block
                  </p>
                  <p className="text-gray-700">
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    The college canteen offers a variety of nutritious and
                    affordable food options in a clean and comfortable
                    environment. Special care is taken to maintain hygiene and
                    quality.
                  </p>
                  <p className="text-gray-700 mt-2">
                    <span className="font-semibold">Location:</span> Central
                    Campus Area
                  </p>
                  <p className="text-gray-700">
                    <span className="font-semibold">Timing:</span> 8:30 AM -
                    4:30 PM (Monday-Saturday)
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    Separate common rooms for male and female students provide a
                    space to relax, socialize, and engage in recreational
                    activities during free periods.
                  </p>
                  <p className="text-gray-700 mt-2">
                  ...
                  <p className="text-gray-700">
                    <span className="font-semibold">Facilities:</span> Indoor
                    games, newspapers, magazines, TV
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <Card className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-gray-700 mb-4">
                    The college has a dedicated Anti-Ragging Cell to ensure a
                    ragging-free campus environment. Any form of ragging is
                    strictly prohibited and punishable as per UGC regulations.
                  </p>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>
                    Fair and transparent grievance resolution
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 mb-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-700 mt-2">
                      <span className="font-semibold">Contact:</span>{" "}
                      grievance@gndu-verka.ac.in
                    </p>
                    <p className="text-gray-700">
                      <span className="font-semibold">Office Hours:</span> 10:00
                      AM - 3:00 PM (Monday-Friday)
                    </p>
                  </div>
        ...
        <section className="py-12 bg-[#0c2340] text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Make the most of your college experience by participating in
